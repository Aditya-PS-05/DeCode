...
const HomePage = () => {
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-gray-900 via-gray-800 to-black">
      {/* Header/Nav */}
      <header className="w-full flex justify-between items-center px-6 py-4 shadow-sm bg-gray-800/75 border-b border-gray-700">
        <div className="flex items-center gap-3">
          <Logo />
        </div>
        <nav className="flex items-center gap-6">
          <Link to="/dashboard" className="text-gray-300 font-medium hover:text-green-400 transition">Dashboard</Link>
          <Link to="/auth">
